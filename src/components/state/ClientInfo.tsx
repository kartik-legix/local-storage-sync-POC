...
function ClientInfo() {
    ...
    const clientInfo = useMainStore(state => state.clientInfo)
    const setClientInfo = useMainStore(state => state.setClientInfo)
    const handleClientInfoFolderChange = useMainStore(state => state.handleClientInfoFolderChange)
